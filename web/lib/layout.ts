...
/* The math lives in lib/paginate.ts, which has no livekit-client import, so the
 * admin lists can share it. Re-exported here because the stage and its tests
 * already import paging from this module. */
export { paginate, type Page } from "./paginate.ts";
