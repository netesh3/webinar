...
--
-- Both are gated per account by the switches added in 0048 (`crm_tags`, `crm_notes`).
...
/* The third audience a broadcast can have, which 0045 left out of its CHECK because
...
/* The sequence trigger the plan asked for in 0046 and could not have: tag_added.
 *
...
/* The bot step that sets a tag, which 0047 left out for the same reason.
 *
 ...
 *
 * 0044 noted that a replay message had no trigger on any channel: nothing in this
 ...
 *
 * 0044 listed the three kinds that existed then. Without this the replay is a message
