...
--
-- And, as in 0044, the messages themselves are NOT here. Each step that comes due is
...
CREATE TABLE crm_drip_steps (
    ...
    -- foreign key into the template cache, for the reason given in 0044.
 ...
 *
 * No unique index on (drip_enrollment_id, position) to match 0044's one-per-broadcast
